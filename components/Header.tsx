      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-white border-b border-surface-border shadow-2xl max-h-[85vh] overflow-y-auto animate-in slide-in-from-top-4 duration-200">
          <div className="p-4 space-y-3">
            ...
            <Link
              href="/patient"
              className="flex items-center justify-between p-3 rounded-xl bg-teal-50 border border-teal-200/80 text-teal-900 font-bold text-xs"
            >
              <div className="flex items-center gap-2">
                <Shield className="w-4 h-4 text-teal-700" />
                <span>Patient Health Portal</span>
              </div>
              <span className="text-[10px] text-teal-700">Login →</span>
            </Link>
